...
"""
                ...
                query = """Find the ASCII values of characters in INDIA and then compute the sum of exponentials of those values 
                           Wrap the final resultant value inside a text box from the Paint Application"""
                ...
                while iteration < max_iterations:
                    ...
                    if response_text.startswith("FUNCTION_CALL:"):
                        ...
                        result = await session.call_tool("select_rectangle_tool", arguments={})
